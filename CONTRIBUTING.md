...
[Issues](https://github.com/ropensci/forcis/issues) that might help you.
...
- Use the template
  [other_issue.md](https://github.com/ropensci/forcis/blob/master/.github/ISSUE_TEMPLATE/other_issue.md).
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/ropensci/forcis/issues?q=label%3Abug).
...
- Open a new [Issue](https://github.com/ropensci/forcis/issues/new).
- Use the template
  [bug_report.md](https://github.com/ropensci/forcis/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Perform a [search](https://github.com/ropensci/forcis/issues) to see
...
Issues](https://github.com/ropensci/forcis/issues).

- Open a new [Issue](https://github.com/ropensci/forcis/issues/new).
- Use the template
  [feature_request.md](https://github.com/ropensci/forcis/blob/master/.github/ISSUE_TEMPLATE/feature_request.md).
...
7.  Submit a [Pull
    ...
    on the [original repo](https://github.com/ropensci/forcis/compare).
